      ...
      <header className="flex flex-col gap-4 bg-white px-6 py-4 shadow-sm sm:flex-row sm:items-center sm:justify-between">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <nav className="flex flex-wrap gap-2 text-sm text-slate-600">
            <button className="rounded-full px-4 py-2 hover:bg-slate-100" onClick={() => navigate("/pannel/dashboard")}>
              Dashboard
            </button>
            <button className="rounded-full px-4 py-2 hover:bg-slate-100" onClick={() => navigate("/pannel/employees")}>
              Employees
            </button>
            <button className="rounded-full px-4 py-2 hover:bg-slate-100"   onClick={() => navigate("/pannel/attendance")}>
              Attendance
            </button>
            <button className="rounded-full px-4 py-2 hover:bg-slate-100" onClick={() => navigate("/pannel/payroll")}>
              Payroll
            </button>
          </nav>
        </div>
        ...
        <aside className="rounded-3xl bg-white p-6 shadow-sm">
          ...
          <ul className="space-y-2 text-sm text-slate-600">
            {[
              ...
              { label: "Employee Directory", path: "/admin/employee" },
